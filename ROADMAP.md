...
Goal: Refactor the example game to use the Battle Companies Core ECS

- [ ] Refactor Sprites to Components
    - [ ] Sprites use Transform Component for Position, Scale, Rotation
- [ ] Refactor Animated Sprites to Components
- [ ] Add Systems for Rendering Sprites 
- [ ] Add Animated Sprites System